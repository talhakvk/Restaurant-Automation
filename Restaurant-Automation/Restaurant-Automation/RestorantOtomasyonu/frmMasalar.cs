...
namespace RestorantOtomasyonu
{
    public partial class frmMasalar : DevExpress.XtraEditors.XtraForm
    {
                ...
                foreach (Control item in this.Controls)
                {
                    if (item is Button)
                    {
                        ...
                        else if (item.Name == "btnMasa" + dr["ID"].ToString() && dr["DURUM"].ToString() == "2")
                        {
                            ...
                            item.Font = new System.Drawing.Font("Arial", 12, FontStyle.Bold);
        ...
        // DLL Import işlemi: Formu hareket ettirmek için gerekli
        [DllImport("user32.dll")]
        public static extern int SendMessage(IntPtr hWnd, int Msg, int wParam, int lParam);
        [DllImport("user32.dll")]
        public static extern bool ReleaseCapture();

        private void frmMasalar_MouseDown(object sender, MouseEventArgs e)
        {
